...
### 풀이과정
```
★(Measurable[] objects) 아무리 생각을 해봐도 잘 모르겠어서 구글링을 통해 알아본 결과 배열에 객체를 넣는 것으로 이해하고 문제를 풀었습니다.
...
![hyperlink] https://stackoverflow.com/questions/63653773/trying-to-write-a-method-to-find-the-largest-object-from-an-array
